...
class PemasukanService {
    ...
    try {
      ...
      if (success) {
        ...
        await _logService.createLog(
          kategori: 'Pemasukan - Kategori Iuran',
          deskripsi:
              name.toString().isNotEmpty
                  ? 'Menambahkan kategori iuran $name'
                  : 'Menambahkan kategori iuran baru',
        );
      }
      return success;
    } catch (e) {
    ...
    try {
      ...
      if (success) {
        ...
        await _logService.createLog(
          ...
          deskripsi:
              name.toString().isNotEmpty
                  ? 'Memperbarui kategori iuran $name (ID: $id)'
                  : 'Memperbarui kategori iuran (ID: $id)',
        );
      }
      return success;
    } catch (e) {
  ...
  Future<bool> deleteKategoriIuran(int id) async {
    try {
      ...
      if (success) {
        await _logService.createLog(
          kategori: 'Pemasukan - Kategori Iuran',
          deskripsi: 'Menghapus kategori iuran (ID: $id)',
        );
      }
      return success;
    } catch (e) {
  ...
  Future<bool> createTagihan(Map<String, dynamic> payload) async {
    try {
      ...
      final success = resp.statusCode == 201;
      if (success) {
        final keluargaId = payload['keluarga_id'];
        final periode = payload['periode'] ?? '';
        await _logService.createLog(
          kategori: 'Pemasukan - Tagihan',
          deskripsi: 'Membuat tagihan baru${keluargaId != null ? ' untuk keluarga ID $keluargaId' : ''}${periode.toString().isNotEmpty ? ' periode $periode' : ''}',
        );
      }
      return success;
    } catch (e) {
    ...
    try {
      ...
      if (success) {
        ...
        await _logService.createLog(
          kategori: 'Pemasukan - Tagihan',
          deskripsi:
              periode.toString().isNotEmpty
                  ? 'Memperbarui tagihan (ID: $id) periode $periode'
                  : 'Memperbarui tagihan (ID: $id)',
        );
      }
      return success;
    } catch (e) {
  ...
  Future<bool> deleteTagihan(int id) async {
    try {
      ...
      if (success) {
        await _logService.createLog(
          kategori: 'Pemasukan - Tagihan',
          deskripsi: 'Menghapus tagihan (ID: $id)',
        );
      }
      return success;
    } catch (e) {
    ...
    try {
      ...
      if (success) {
        ...
        await _logService.createLog(
          ...
          deskripsi:
              name.toString().isNotEmpty
                  ? 'Menambahkan pemasukan lain $name'
                  : 'Menambahkan pemasukan lain',
        );
      }
      return success;
    } catch (e) {
    ...
    try {
      ...
      if (success) {
        ...
        await _logService.createLog(
          ...
          deskripsi:
              name.toString().isNotEmpty
                  ? 'Memperbarui pemasukan lain $name (ID: $id)'
                  : 'Memperbarui pemasukan lain (ID: $id)',
        );
      }
      return success;
    } catch (e) {
  ...
  Future<bool> deletePemasukanLain(int id) async {
    try {
      ...
      if (success) {
        await _logService.createLog(
          kategori: 'Pemasukan - Lainnya',
          deskripsi: 'Menghapus pemasukan lain (ID: $id)',
        );
      }
      return success;
    } catch (e) {
