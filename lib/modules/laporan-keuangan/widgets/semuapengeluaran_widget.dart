...
// Widget Mobile Card untuk Pengeluaran
...
/// Widget utama yang menampilkan daftar Pengeluaran dalam bentuk list card.
class SemuaPengeluaranCardList extends StatelessWidget {
  ...
  const SemuaPengeluaranCardList({super.key, required this.data, required this.onCardAction});
